...
# Generate the output
output_1 = model.generate(input_ids, max_length=150, num_return_sequences=1)
output_2 = model.generate(input_ids, max_length=150, num_return_sequences=1)
o = .6*output_2 + .4*output_1
# print('RAW OUTPUT 1 --- ', output_1*6)
print('RAW OUTPUT 2 --- ', o)

# Decode the generated text
decoded_output = tokenizer.decode(o[0], skip_special_tokens=True)
